...
package de.knowwe.rdfs.literal;
...
/**
 * Language tag for string literal values.
 * 
 * @author Jochen Reutelshoefer
 * @created 23.10.2012
 */
public class LanguageTag extends AbstractType {
	...
	public LanguageTag() {
		...
		this.setRenderer(new StyleRenderer("color:orange;"));
