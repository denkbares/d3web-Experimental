...
import de.knowwe.lexiconinterface.db.MySQLConnector;
...
/**
 * Created by ru4262 on 06.11.2014.
 */
public class OpenThesaurusProvider implements LexiconProvider{
    MySQLConnector connector;
    private final static Logger log = LoggerFactory.getLogger(OpenThesaurusProvider.class);

    public OpenThesaurusProvider() {
    ...
    public List<String> getSynonyms(String word) {
        return connector.getSynonyms(word);
    }
    ...
    public List<String> getAntonyms(String word) {
        return connector.getAntonyms(word);
    }
    ...
    public List<String> getAllCategories() {
        return connector.getAllCategories();
    }
}
