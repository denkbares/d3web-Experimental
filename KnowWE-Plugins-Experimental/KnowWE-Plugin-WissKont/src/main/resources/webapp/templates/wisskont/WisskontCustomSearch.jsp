...
<%@ page import="de.knowwe.compile.IncrementalCompiler" %>
...
<%
    ...
    // Get the possible and existing term names
	...
	for (Section<? extends SimpleDefinition> def : allTermDefinitions) {
		terms.add(def.get().getTermName(def));
	} 		
    ...
    // Check if searched term is an existing term
