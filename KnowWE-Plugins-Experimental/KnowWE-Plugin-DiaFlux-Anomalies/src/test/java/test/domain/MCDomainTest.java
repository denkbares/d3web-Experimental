...
public class MCDomainTest {
	...
	public void testConstructor2() throws Exception {
		assertThat(new MCDomain(q).getChoices(), is(parse("a,b,c,d,e")));
	}
	...
	MCDomain domain(String s) {
		return new MCDomain(q, parse(s));
	}
