 ...
 * @created 24.05.2011
 */
public class InverseOf extends AbstractType {
	...
	public InverseOf() {
		...
		this.addChildType(new InverseOfContentType());
	}
	 ...
	 * @created 18.05.2011
	 */
	class InverseOfContentType extends AbstractType {

		protected InverseOfContentType() {
