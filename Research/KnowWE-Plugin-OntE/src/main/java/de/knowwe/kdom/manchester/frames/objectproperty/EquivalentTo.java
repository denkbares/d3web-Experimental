 ...
 * @created 24.05.2011
 */
public class EquivalentTo extends AbstractType {
	...
	public EquivalentTo() {
		...
		this.addChildType(new EquivalentToContentType());
	}
	 ...
	 * @created 18.05.2011
	 */
	class EquivalentToContentType extends AbstractType {

		protected EquivalentToContentType() {
