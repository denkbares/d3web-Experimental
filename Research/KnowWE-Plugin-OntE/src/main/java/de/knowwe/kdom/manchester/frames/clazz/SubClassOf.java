 ...
 * @created 24.05.2011
 */
public class SubClassOf extends AbstractType{
	...
	public SubClassOf() {
		...
		this.addChildType(new SubclassOfContentType());
	}
	 ...
	 * @created 18.05.2011
	 */
	class SubclassOfContentType extends AbstractType {

		protected SubclassOfContentType() {
			this.setSectionFinder(new AllTextFinderTrimmed());

			Keyword key = new Keyword(SubClassOf.KEYWORD);
