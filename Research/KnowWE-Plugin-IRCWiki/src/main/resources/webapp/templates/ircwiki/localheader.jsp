...
<!-- IRCWIKI styles -->     
<link href="templates/ircwiki/stylesheet_ci2.css" media="screen" type="text/css" rel="stylesheet">
<link href="templates/ircwiki/stylesheet_ci.css" media="screen" type="text/css" rel="stylesheet">
<link href="templates/ircwiki/i3-typo3.css" media="screen" type="text/css" rel="stylesheet"> 