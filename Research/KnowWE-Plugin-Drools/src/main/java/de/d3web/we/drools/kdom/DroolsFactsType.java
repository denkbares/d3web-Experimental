...
/**
 * Content type for the DroolsFacts section. Can contain Comments or DroolsFacts
 * 
...
public class DroolsFactsType extends AbstractType {
	...
	static class DroolsFactsSubtreeHandler extends SubtreeHandler<DroolsFactsType> {
		...
		/*
		 * For testing purposes only, can be removed! (non-Javadoc)
		 * 
		 * @see
		 * de.d3web.we.kdom.ReviseSubTreeHandler#reviseSubtree(de.d3web.we.kdom
		 * .Article, de.d3web.we.kdom.Section)
		 */
		@Override
		public Collection<Message> create(Article article, Section<DroolsFactsType> s) {
			...
			System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++");
			System.out.println("FactsStore of Article \"" + article.getTitle() + "\" contains "
					+ factsStore.size() + " facts.");
			System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++");
