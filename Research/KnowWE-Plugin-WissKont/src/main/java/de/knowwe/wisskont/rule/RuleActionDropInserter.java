 ...
 * @created 08.08.2013
 */
public class RuleActionDropInserter implements DragDropEditInserter<RuleActionKeyType> {
	...
	@Override
	public Class<RuleActionKeyType> getTypeClass() {
		return RuleActionKeyType.class;
	}
