 ...
 * @created 22.05.2013
 */
public class SingleParentTest extends AbstractTest<Rdf2GoCore> {
	...
	public String getDescription() {
		return "Tests whether there is for each concept at most one parent concept, i.e. check for tree characteristic.";
	}
