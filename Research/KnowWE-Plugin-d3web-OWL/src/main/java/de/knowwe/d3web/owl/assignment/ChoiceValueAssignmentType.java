...
public class ChoiceValueAssignmentType extends AssignmentType {
	...
	private class ChoiceValueAssignmentCompiler extends AssignmentCompiler<ChoiceValueAssignmentType> {
		...
		@Override
		protected Assignment createAssignment(KnowWEArticle article, Section<ChoiceValueAssignmentType> s, KnowledgeBase kb, OWLOntologyUtil util, String baseURI, Collection<KDOMReportMessage> messages) {
			/* Get the question */
		...
		private QuestionChoice getQuestion(KnowWEArticle article, Section<ChoiceValueAssignmentType> s, Collection<KDOMReportMessage> messages) {
