...
public class ContentDocument {
    ...
    private void init() {
        ...
        StyleManager.getInstance().addStyles(
                docRoot.getChild("automatic-styles", NamespaceManager.office).getChildren("style", NamespaceManager.style));
    ...
    private String convert(List elements, StringBuilder buffy) {
