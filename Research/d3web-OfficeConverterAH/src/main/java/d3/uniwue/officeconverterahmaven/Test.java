...
public class Test {
    ...
    private static String wordinput = 
            "/Users/mafre/Promotion/Projects/2012JuriSearch/WordParsing/RNS_Swap_EN_min1.doc";
    private static String cleanedIntermedHtml = 
            "/Users/mafre/Promotion/Projects/2012JuriSearch/WordParsing/RNS_Swap_EN_min1_cleanedIntermed.html";
    ...
    private static String wordhtmlFinalOutput = 
            "/Users/mafre/Promotion/Projects/2012JuriSearch/WordParsing/RNS_Swap_EN_min1_final.html";
	...
	public static void main(String[] args) {
		try {
			Config conf = new Config().setEmbeddedObjectsDir(embeddedObjectsDir).setWithLists(true).setLeaveUmlauts(true).setWithHeadlineDepths(true);
