 ...
 * @created 29.01.2013
 */
public class LinkToMinVisualizationToolProvider implements ToolProvider {
	...
	public Tool[] getTools(Section<?> section, UserContext userContext) {
		...
		String encoded = "";
		try {
			encoded = URLEncoder.encode(termName, "UTF-8");
		}
		catch (UnsupportedEncodingException e) {
			System.out.println("Encoder failed to encode!!");
			e.printStackTrace();
		}
