...
Testcase.importTestcase = function(sectionID) {
	...
	var form = jq$('<form>', {id:'testcaseImport', method:'post', enctype:'multipart/form-data', action:'KnowWE.jsp?action=TestcaseImportAction'})
	.append(jq$('<input>', {type:'file', name:'testcasefile', size:50}))
	.append(jq$('<input>', {type:'hidden', name:'SectionID', value:sectionID}));
