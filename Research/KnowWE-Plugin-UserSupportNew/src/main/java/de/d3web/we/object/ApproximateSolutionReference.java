 ...
 * @created 26.07.2010
 */
public class ApproximateSolutionReference extends D3webTermReference<Solution> {

	public ApproximateSolutionReference() {
	...
	public Solution getTermObjectFallback(KnowWEArticle article, Section<? extends TermReference<Solution>> s) {
		if (s.get() instanceof ApproximateSolutionReference) {

			Section<ApproximateSolutionReference> sec = (Section<ApproximateSolutionReference>) s;
