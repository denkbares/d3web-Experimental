...
import de.d3web.we.condition.ApproximateCondKnown;
import de.d3web.we.condition.ApproximateCondKnownUnknown;
import de.d3web.we.condition.ApproximateCondUnknown;
import de.d3web.we.condition.ApproximateSolutionStateCond;
import de.d3web.we.condition.ApproximateUserRatingConditionType;
 ...
 * 
 */
public class ApproximateRuleContentType extends AbstractType {
	 ...
	 * 
	 */
	public ApproximateRuleContentType() {
		...
		termConds.add(new ApproximateSolutionStateCond());
		termConds.add(new ApproximateUserRatingConditionType());
		termConds.add(new ApproximateCondKnownUnknown());
		termConds.add(new ApproximateFinding());
		termConds.add(new ApproximateCondUnknown());
		termConds.add(new ApproximateCondKnown());
		...
		public void render(KnowWEArticle article,
			...
			if (ruleAction != null) {
				rule = (Rule) KnowWEUtils.getStoredObject(article, ruleAction,
						ApproximateRuleContentType.ruleStoreKey);
			}
