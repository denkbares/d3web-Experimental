 ...
 * @created 26.10.2010
 */
public class ApproximateSolutionStateType extends AbstractType {
	...
	public ApproximateSolutionStateType() {
		this.setCustomRenderer(new DefaultTextRenderer());
	}

	public static Rating.State getSolutionState(Section<ApproximateSolutionStateType> s) {
