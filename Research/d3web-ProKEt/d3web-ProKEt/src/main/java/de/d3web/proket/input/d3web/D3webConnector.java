...
public class D3webConnector {
	...
	/*
	 * The ContainerCollection needed for assembling the complete HTML,JS,etc
	 * for rendering
	 */
	private ContainerCollection cc;
	...
	public ContainerCollection getContainerCollection() {
		return cc;
	}

	public void setContainerCollection(ContainerCollection cc) {
		this.cc = cc;
	}
}
