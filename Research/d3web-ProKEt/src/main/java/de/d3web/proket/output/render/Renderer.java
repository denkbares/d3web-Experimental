...
public class Renderer implements IRenderer {
    ...
    protected void fillTemplate(IDialogObject dialogObject, StringTemplate st) {
        ...
        if (dialogObject.getParent() != null) {
            st.setAttribute("parentFullId", dialogObject.getParent().getFullId());
        }
    ...
    @Override
    /**
     * Render dialog object with a given container collection and set standard
     * case of NOT excluding children
     */
    ...
    @Override
    public String renderDialogObject(ContainerCollection cc,
            IDialogObject dialogObject, boolean recurseCount) {
        return renderDialogObject(cc, dialogObject, recurseCount, false);
    }

    @Override
    /**
     * Render dialog object with given cc, given excludeChildren-flag, and set
     * forceToOverwrite as standard false
     */
    public String renderDialogObject(ContainerCollection cc,
            IDialogObject dialogObject, boolean recurseCount, boolean excludeChildren) {
        return renderDialogObject(cc, dialogObject, recurseCount, excludeChildren, false);
    }
    ...
    public String renderDialogObject(ContainerCollection cc,
        ...
        return renderDialogObject(cc, dialogObject, recurseCount, excludeChildren, force,
                null);
    }
    ...
    @Override
    /**
     * Render the tree with a given container collection
     */
    ...
    @Override
    /**
     * Render the tree with a given container collection and a constraint
     * whether to exclude children rendering or not (standard case: do not
     * exclude)
     */
    public void renderRoot(DialogTree dialogTree, ContainerCollection cc,
    ...
    public void renderRootD3web(DialogTree dialogTree, ContainerCollection cc,
        ...
        String result =
                renderDialogObject(cc, dialogObject, true, false, true, session);
