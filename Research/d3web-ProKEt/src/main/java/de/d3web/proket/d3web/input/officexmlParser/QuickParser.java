 ...
 /*       if (text.contains("[LINK:")) {
            ...
            for (Object pdf : pdfs) {
                ...
                if (!webappPrefix.equals("")) {
                    ...
                    replaced = "&#60;a href=\"/resources/" + pdf.toString()
                            + ".pdf\"&#62; " + pdf.toString() + "&#60;/a&#62;";
                }
  ...
  /*      if (text.contains("[WEBLINK:")) {
            ...
            for (Object link : links) {
                ...
                if (!webappPrefix.equals("")) {
                    replaced = "&#60;a href=\"/" + webappPrefix + "/Dialog?src=" + link.toString() + "\"&#62; "
                            + link.toString() + "&#60;/a&#62;";

                } else {
                    replaced = "&#60;a href=\"/Dialog?src=" + link.toString() + "\"&#62; "
                            + link.toString() + "&#60;/a&#62;";
                }
        ...
        for (String f : questionTexts) {
            ...
            if (!"".equals(f)) {
                ...
                ParserQuestion q = qm.getQuestion(questionID);
                if (q == null) {
    ...
    public ParserQuestionManager parseQuestionTree(String text) {
        ParserQuestionManager qm = new ParserQuestionManager();
        LinkedList<Pair<String, Integer>> l = getAllDashedSubTexts(text);
        LinkedList<ParserQuestion> stack = new LinkedList<ParserQuestion>();
        ParserQuestion lastQuestion = null;
        int lastDepth = 0;
        int count = 1;
    ...
    private ParserQuestion buildQuestion(String s, ParserQuestionManager qm) {
        Pair<String, LinkedList<String>> p = getAllDelimitedTerms(s, "[", "]");
        String rumpf = p.getFirst();
        ParserQuestion knownQ = qm.getQuestion(rumpf);
        if (knownQ != null) {
            return knownQ;
        }
        LinkedList<String> modifiers = p.getLast();
        ParserQuestion q = new ParserQuestion(rumpf, ParserQuestion.UND_MOD);
    ...
    public String getTreePart(String text) {
    ...
    public String getInfoPart(String text) {
        int i = text.indexOf("FRAGE");
        if (i == -1) {
            return "";
        } else {
