...
import de.d3web.proket.d3web.input.D3webConversionUtils;
 ...
 * @param <KnoweldgeBase>
 */
public class SAVE_D3webDialogServlet<KnoweldgeBase> extends HttpServlet {
	 ...
	 */
	public SAVE_D3webDialogServlet() {
		super();
	}
	...
	private void show(HttpServletRequest request, HttpServletResponse response,
		...
		if (dialogType.equals(DialogType.MULTIFORM)) {
			...
			// tree.getRoot().getVirtualClassName());
		}
