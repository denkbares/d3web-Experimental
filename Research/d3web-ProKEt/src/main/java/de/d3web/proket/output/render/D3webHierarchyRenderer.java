 ...
 * @created 14.10.2010
 */
public class D3webHierarchyRenderer {

	// one and only renderer instance
	private static D3webHierarchyRenderer instance;
	...
	public static D3webHierarchyRenderer getInstance(Session s, ContainerCollection c) {
		if (instance == null) {
			instance = new D3webHierarchyRenderer();
		}
		session = s;
		bb = s.getBlackboard();
		cc = c;
	...
	private D3webHierarchyRenderer() {
	}
