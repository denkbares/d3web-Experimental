...
public class OQDConsDefaultRootD3webRenderer extends DefaultRootD3webRenderer {
    ...
    public ContainerCollection renderRoot(ContainerCollection cc,
        ...
        StringTemplate st = StringTemplateUtils.getTemplate("oqdCons/OQDConsD3webDialog");
