 ...
 */
public class D3webXMLParserNewSpec {
     ...
     * set for the parser.
     */
    public D3webXMLParserNewSpec() {
        new D3webXMLParserNewSpec("default.xml");
    }
     ...
     * @param filename
     */
    public D3webXMLParserNewSpec(String filename) {
     ...
     * @param xmlfilename
     */
    private void setSourceToParse(String xmlfilename) {
    ...
    public D3webXMLParserNewSpec.LoginMode getLoginMode() {
        if (XMLUtils.getStr((Element) dialogOpts, "login") != null) {
            return D3webXMLParserNewSpec.LoginMode.valueOf(
                    XMLUtils.getStr((Element) dialogOpts, "login").toUpperCase());
        }
        return D3webXMLParserNewSpec.LoginMode.OFF;
    }
    ...
    public static void main(String[] args) {
        D3webXMLParserNewSpec parser = new D3webXMLParserNewSpec("newXMLSpec.xml");
        parser.parse();
