...
public abstract class DefaultDialogObject implements IDialogObject {
     ...
     * "Renderer" that fits best to the string given. For a definition of best
     * fit see {@link ClassUtils}.
     */
    ...
    @Override
    /**
     * Customized toString() method that returns the most important or
     * interesting properties of a Dialog Object.
     */
