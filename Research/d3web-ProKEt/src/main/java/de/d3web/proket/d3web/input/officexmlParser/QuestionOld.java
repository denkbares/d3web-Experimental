...
public class QuestionOld {
    ...
    private LinkedList<QuestionOld> subQuestions;
    private QuestionOld parent;
    private int id;
    private static int idCounter = 0;
    private boolean invertiereNein;
    private boolean isDummy;

    public QuestionOld(String content, String type) {
        super();
        this.content = content;
        this.type = type;
        subQuestions = new LinkedList<QuestionOld>();
        parent = null;
        score = 0;
        id = idCounter++;
    ...
    public void addChild(QuestionOld c) {
        subQuestions.add(c);
    }

    public LinkedList<QuestionOld> getChildren() {
        return subQuestions;
    }

    public QuestionOld getParent() {
        return parent;
    }

    public void setParent(QuestionOld q) {
        this.parent = q;
    }
