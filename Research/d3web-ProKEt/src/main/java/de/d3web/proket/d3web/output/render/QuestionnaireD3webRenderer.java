...
public class QuestionnaireD3webRenderer extends AbstractD3webRenderer implements IQuestionD3webRenderer {
    ...
    public String renderTerminologyObject(Session d3webSession, ContainerCollection cc,
        ...
        if (uiset.getDialogType().equals(DialogType.SINGLEFORM)) {
            st = StringTemplateUtils.getTemplate("singleForm/QuestionnaireFlat");
        } else {
            st = StringTemplateUtils.getTemplate("Questionnaire");
        }
        ...
        if (uiset.getQuestionnaireNumbering()) {
...
// || 
        ...
        // render the children
        super.renderChildren(st, d3webSession, cc, to, loc, httpSession, request);
