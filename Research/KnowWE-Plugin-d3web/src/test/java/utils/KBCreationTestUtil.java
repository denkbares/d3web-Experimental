...
public class KBCreationTestUtil {
	...
	private void createQuestions() {
		...
		// ---- normal
		// ---- increased
		Question q3 = new QuestionOC(q2, "Mileage evaluation", "normal", "increased");
		...
		// -- unsteady idle speed
		// -- everything is fine
		Question q4 = new QuestionMC(qc1, "Driving",
						"insufficient power on partial load",
						"insufficient power on full load",
						"unsteady idle speed",
						"everything is fine");
	...
	private void createIndicationRules() {
		...
		QuestionChoice actionQuestion3 = (QuestionChoice) createdKB.getManager().searchQuestion(
				"Driving");
		Choice answer2 = KnowledgeBaseUtils.findChoice(condQuestion2, "increased");
