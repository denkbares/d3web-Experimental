...
public class XCLTest extends TestCase {
	...
	public void testXCLModels() {
		...
		Collection<XCLModel> loadedXCLModels = loadedKB.getAllKnowledgeSlicesFor(XCLModel.KNOWLEDGE_KIND);
		Collection<XCLModel> createdXCLModels = createdKB.getAllKnowledgeSlicesFor(XCLModel.KNOWLEDGE_KIND);
