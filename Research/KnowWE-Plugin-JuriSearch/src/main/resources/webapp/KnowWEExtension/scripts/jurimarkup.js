...
/**
 * Namespace: KNOWWE.plugin.juriMarkup The KNOWWE usersupport namespace.
 */
KNOWWE.plugin.jurimarkup = function() {
    ...
    return {
	    ...
	    generateHTML : function(id) {
	    	return KNOWWE.plugin.usersupportinstantedit.generateHTML(id);
	    },
    	...
    	save : function(id) {
    		KNOWWE.plugin.usersupportinstantedit.save(id);
    	},
