...
//
// public JuriTreeXmlGenerator(Section<Article> section) {
// if (isRoot(section)) {
// if (isJuriTreeSection(section)) buildXML(section, "Name of Wiki");
// }
// }
//
// private boolean isRoot(Section<Article> section) {
// Object o = section.get();
// return o instanceof de.knowwe.core.kdom.Article;
// }
//
// private boolean isJuriTreeSection(Section<Article> section) {
// Object o = section.get();
...
//
// // PrintWriter w = new
// // PrintWriter(Environment.getInstance().getWikiConnector().getSavePath()+
// // "\\wikiTest.xml");
// // PrintWriter w = new
// // PrintWriter("C:\\wikis\\juriSearchWiki\\wikiTest.xml");
// // PrintWriter w = new
// //
...
// }
//
// public void buildXML(Section<Article> section, String name) {
// try {
...
// }
//
// public void buildXMLForDashSubtree(XmlWriter w, Section<DashSubtree> section,
// String parent)
// throws XmlWriter.MalformedXmlException, IOException {
// Section jexp = getSectionsWithPath(section, DashTreeElement.class,
// JuriTreeExpression.class).getFirst();
// String text = getSectionsWithPath(jexp,
// QuestionIdentifier.class).getFirst().getText();
// String explanation = getExplanationText(section, text);
// Section nodeMode =
// getFirstSectionWithPath(jexp, JuriTreeExpression.RoundBracketExp.class,
...
// String parentString = "";
// String bonusString = "";
// if (explanation != null) bonusString = " bonus-text=\"" +
// escapeQuotes(explanation) + "\"";
// if (parent != null) parentString = " parent-id='" + parent + "'";
// w.writeFullTag("legalQuestion title='" + text + "' id='" + id + "'" +
// parentString + " "
// + booleanTypeAdd + bonusString);
...
// }
//
// private String getExplanationText(Section<DashSubtree> section, String
// questionText) {
// String explanationText = null;
// de.knowwe.core.compile.terminology.TerminologyManager terminologyHandler =
// Environment
// .getInstance().getTerminologyManager(
...
// if ("oder".equals(roundBracketText)) return "and-or-type='OR'";
...
// Section<? extends Type> section, Class... c) {
// LinkedList<Section<? extends Type>> l = new LinkedList<Section<? extends
// Type>>();
// if (c.length == 0) {
// l.add(section);
// }
